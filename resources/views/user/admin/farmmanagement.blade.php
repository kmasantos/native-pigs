	...
	<div class="container">
	    <div class="row">
	        			...
	        			<tbody>
	        				@forelse($farms as $farm)
		        				<tr>
		        					...
		        					<td><a href="#edit_farm{{$farm->id}}" class="tooltipped modal-trigger" data-position="top" data-tooltip="Edit"><i class="fas fa-pencil-alt"></i></a></td>
		        				</tr>
		        				{{-- MODAL STRUCTURE --}}
									...
									<div class="modal-content">
										...
										<div class="row center">
											<div class="input-field col s8 m8 l8 offset-s2 offset-m2 offset-l2">
												<input id="name" type="text" name="name" class="validate" value="{{ $farm->name }}" required>
			...
			<div id="add_farm" class="modal">
				...
				<div class="row center">
					<button class="btn waves-effect waves-light green darken-3" type="submit" onclick="Materialize.toast('New farm added successfully!', 4000)">
            			Submit <i class="material-icons right">send</i>
          			</button>
				</div>
				{!! Form::close() !!}
