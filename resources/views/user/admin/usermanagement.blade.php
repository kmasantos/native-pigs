									...
									<div class="modal-content">
										...
										<div class="row center">
											<div class="input-field col s6 m6 l6">
												<input id="name" type="text" name="username" class="validate" value="{{ $user->name }}" required>
												<label for="name">Name</label>
											</div>
											<div class="input-field col s6 m6 l6">
												<input id="email" type="email" name="user_email" class="validate" value="{{ $user->email }}" required>
