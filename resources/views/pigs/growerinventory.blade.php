...
@section('content')
	<div class="container">
		...
		<div class="fixed-action-btn">
		  ...
		  <ul>
		    <li><a href="{{ URL::route('farm.pig.grower_inventory_download_pdf', [$filter]) }}" class="btn-floating green darken-1 tooltipped" data-position="left" data-tooltip="Download as PDF"><i class="material-icons">file_copy</i></a></li>
		  </ul>
		</div>
	</div>
@endsection
