...
@section('content')
    ...
    <div class="fixed-action-btn">
      ...
      <ul>
        ...
        <li><a href="{{route('farm.pig.morpho_chars_download_pdf')}}"class="btn-floating green darken-1 tooltipped" data-position="left" data-tooltip="Download as PDF"><i class="material-icons">file_copy</i></a></li>
      </ul>
    </div>
  </div>
@endsection
