...
@section('content')
    ...
    <div class="fixed-action-btn">
      ...
      <ul>
        @if($filter == "All")
          <li><a href="{{ URL::route('farm.pig.morpho_chars_all_download_csv') }}" class="btn-floating green lighten-1 tooltipped" data-position="left" data-tooltip="Download as CSV File"><i class="material-icons">table_chart</i></a></li>
        ...
        @elseif($filter == "Sow")
          <li><a href="{{ URL::route('farm.pig.morpho_chars_sow_download_csv') }}" class="btn-floating green lighten-1 tooltipped" data-position="left" data-tooltip="Download as CSV File"><i class="material-icons">table_chart</i></a></li>
        ...
        @elseif($filter == "Boar")
          <li><a href="{{ URL::route('farm.pig.morpho_chars_boar_download_csv') }}" class="btn-floating green lighten-1 tooltipped" data-position="left" data-tooltip="Download as CSV File"><i class="material-icons">table_chart</i></a></li>
