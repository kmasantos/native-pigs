...
@section('content')
  <h4 class="headline"><a href="{{route('farm.pig.individual_records')}}"><img src="{{asset('images/back.png')}}" width="3%"></a> Boar Record</h4>
  <div class="container">
    <div class="row">
    	{!! Form::open(['route' => 'farm.pig.fetch_boar_record_id', 'method' => 'post']) !!}
      <div class="col s12">
      	<input type="hidden" name="animal_id" value="{{ $boar->id }}">
