...
@section('content')
  <h4 class="headline"><a href="{{route('farm.pig.breeder_records')}}"><img src="{{asset('images/back.png')}}" width="3%"></a> View Boar</h4>
  <div class="container">
    <div class="row">
      <div class="col s12">
        <div class="row">
          <div class="col s4">
            <img src="{{asset('images/boar.jpg')}}" width="95%">
          </div>
          <div class="col s8">
            <div class="white black-text">
              <h5><strong>{{ $boar->registryid }}</strong></h5>
            </div>
            <div style="margin-top:10px;">
              <div class="col s12 card-panel white black-text">
                <div class="col s6">
                  ...
                  @else
                    <p><strong>Littersize Born Alive:</strong> {{ count($boar->getGrouping()->getGroupingMembers()) }}</p>
                  @endif
                  @if($ageAtFirstMating != "")
