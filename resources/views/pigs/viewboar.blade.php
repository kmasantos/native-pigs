...
@section('content')
  <h4 class="headline"><a href="{{route('farm.pig.individual_records')}}"><img src="{{asset('images/back.png')}}" width="3%"></a> View Boar</h4>
  <div class="container">
    <div class="row">
      <div class="col s12">
        <div class="row">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if($boar->weightrecord == 1)
                      <td>{{ round($properties->where("property_id", 66)->first()->value, 4) }} kg/m<sup>3</sup></td>
                    @else
