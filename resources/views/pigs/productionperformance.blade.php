...
@section('content')
	<div class="container">
		...
		<div class="fixed-action-btn">
		  ...
		  <ul>
		    <li><a href="{{ URL::route('farm.pig.production_perf_summary_download_csv') }}" class="btn-floating green lighten-1 tooltipped" data-position="left" data-tooltip="Download as CSV File"><i class="material-icons">table_chart</i></a></li>
		    <li><a href="{{ URL::route('farm.pig.production_perf_summary_download_pdf') }}" class="btn-floating green darken-1 tooltipped" data-position="left" data-tooltip="Download as PDF"><i class="material-icons">file_copy</i></a></li>
		  </ul>
		</div>
	</div>
@endsection
